		...
		<div className="flex flex-col items-center rounded-box justify-center w-1/3 mx-auto bg-neutral pt-5">
			...
			<div className="w-full max-w-screen-xl mx-auto space-y-4 p-6 rounded-box">
				<div className="flex items-center space-x-2">
					<label htmlFor={"email"} className="font-medium w-24 text-accent">
						Email Address:
					</label>
					<input
						type="email"
				...
				<div className="flex items-center space-x-2">
					<label htmlFor={"password"} className="font-medium w-24 text-accent">
						Password:
					</label>
					<input
						type="password"
				...
				<div>
					<button onClick={onSubmitLogin} className="btn btn-primary w-full">
						Submit
					</button>
				</div>
			</div>
