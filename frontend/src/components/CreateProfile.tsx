...
export const CreateProfile = () => {
	...
	return (
		<div className="flex flex-col items-center bg-slate-700 w-4/5 mx-auto p-5 rounded-box">
			...
			<div className="flex flex-col w-full mb-5">
				<label htmlFor="petType" className="text-blue-300 mb-2">
					Pet Type
				</label>
				<input
					placeholder="Dog..."
			...
			<div className="flex flex-col w-full mb-5">
				<label htmlFor="profilepic" className="text-blue-300 mb-2">
			...
			{name != null && password != null && selectedFile != null && (
				<div>
					<button className="btn btn-primary btn-circle" onClick={onUploadFile}>
						Create
					</button>
				</div>
			)}
